...
var Counter = React.createClass({displayName: "Counter",
  render: function() {
    ...
    return (React.createElement("div", null, 
        ...
        React.createElement("button", {style: styleObj, onClick: this.props.onClick}, "⊕")
      ))
  }
});
...
var CounterSet = React.createClass({displayName: "CounterSet",
  ...
  renderCounter: function (counter) {
    ...
    return (React.createElement(Counter, {count: count, purpose: purpose, onClick: this.counterIncrease.bind(this, counter)}))
  },
  getTotal: function () {
  ...
  render: function() {
      return (React.createElement("div", null, 
        React.createElement("h1", null, "Hello, I can count stuff using Callbacks!"), 
...
React.render(React.createElement(CounterSet, null), global.document.getElementById('myApp'));
...
},{"./ReactCurrentOwner":37,"./ReactElement":53,"./ReactPropTypeLocations":72,"./monitorCodeUse":137,"./warning":146,"_process":148}],55:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014, Facebook, Inc.
 * All rights reserved.
