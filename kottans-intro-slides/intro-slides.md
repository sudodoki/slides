...
+ шея / спина
+ хороший стул
+ периодические активность
+ периодические целенаправленное занятие спортом
...
# git - обычно самое сложное, с чем приходиться начинать работать
+ rebase vs merge
+ refs
+ хуки
...
## Самые важные скиллы
+ уметь договариваться ("пропихивать" свое решение, компромиссы, anger management)
